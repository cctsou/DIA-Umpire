...
abstract public class ExponentialFamily<ParamX extends Parameter, ParamD extends Parameter> implements Serializable {
     ...
     * @return \f$ div F( \mathbf{\Theta}_P \| \mathbf{\Theta}_Q ) =
     * F(\mathbf{\Theta}_P) - F(\mathbf{\Theta}_Q) - \langle
     * \mathbf{\Theta}_P-\mathbf{\Theta}_Q , \nabla F(\mathbf{\Theta}_Q)
     * \rangle\f$
     */
     ...
     * @return \f$ div G( \mathbf{H}_P \| \mathbf{H}_Q ) = G(\mathbf{H}_P) -
     * G(\mathbf{H}_Q) - \langle \mathbf{H}_P-\mathbf{H}_Q , \nabla
     * G(\mathbf{H}_Q) \rangle\f$
     */
    ...
    /**
     * Computes the density value \f$ f(x;\mathbf{\Theta}) \f$ of an exponential
     * family member.
     *
     * @param x a point
     * @param T natural parameters \f$ \mathbf{\Theta} \f$
     * @return \f$ f(x) = \exp \left( \langle \mathbf{\Theta} \ , \ t(x) \rangle
     * - F(\mathbf{\Theta}) + k(x) \right) \f$
     */
    ...
    /**
     * Computes the Bregman divergence between two members of a same exponential
     * family.
     *
     * @param T1 natural parameters \f$ \mathbf{\Theta}_1\f$
     * @param T2 natural parameters \f$ \mathbf{\Theta}_2\f$
     * @return \f$ BD( \mathbf{\Theta_1} \| \mathbf{\Theta_2} ) =
     * F(\mathbf{\Theta_1}) - F(\mathbf{\Theta_2}) - \langle \mathbf{\Theta_1} -
    ...
    /**
     * Computes the Kullback-Leibler divergence between two members of a same
     * exponential family.
     *
