...
public class HierarchicalMixtureModel {
    ...
    /**
     * Extracts a mixture model for a given resolution from the hierarchical
     * mixture model. The resolution 1 corresponds to a mixture model with only
     * one model.
     *
    ...
    /**
     * Computes the "optimal" mixture model given a threshold on the KLD
