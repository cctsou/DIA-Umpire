 ...
 * \f$f\f$ evaluated at \f$x \in R^d\f$ is given by \f[ f(x) = \sum_{i=1}^n
 * \alpha_i f_i(x)\f] where \f$\alpha_i \in [0,1]\f$ denotes the weight of the
 * \f$i^{\textrm{th}}\f$ mixture component \f$f_i\f$ such as \f$\sum_{i=1}^n
 * \alpha_i=1\f$. The MixtureModel class provides a convenient way to create and
 * manage mixture of exponential families.
 */
public class MixtureModel implements Serializable {
    ...
    /**
     * Normalizes the weights of the mixture models \f$ \alpha_i \f$ such as \f$
     * \sum_{i=1}^n \alpha_i = 1 \f$.
     */
