 ...
 * \mathbf{\Theta} \rangle - F(\mathbf{\Theta}) + k(x) \right) \f] where \f$
...
public final class UnivariateGaussianFixedVariance extends ExponentialFamily<PVector, PVector> {
     ...
     * @return \f$ F(\mathbf{\Theta}) = \frac{\sigma^2 \theta^2 + \log(2 \pi
     * \sigma^2)}{2} \f$
     */
     ...
     * @return \f$ D_{\mathrm{KL}}(f_P\|f_Q) = \frac{(\mu_Q-\mu_P)^2}{2\sigma^2}
     * \f$
     */
