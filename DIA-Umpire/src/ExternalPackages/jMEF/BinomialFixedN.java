...
public final class BinomialFixedN extends ExponentialFamily<PVector, PVector> {
     ...
     *
     * @param T natural parameters \f$ \mathbf{\Theta} = \theta \f$
     * @return \f$ \nabla F( \mathbf{\Theta} ) = \frac{n \exp \theta}{1 + \exp
     * \theta} \f$
     */
     ...
     * @return \f$ G(\mathbf{H}) = \eta \log \left( \frac{\eta}{n-\eta} \right)
     * - n \log\left( \frac{n}{n-\eta} \right) \f$
     */
     ...
     *
     * @param H expectation parameters \f$ \mathbf{H} = \eta \f$
     * @return \f$ \nabla G( \mathbf{H} ) = \log \left( \frac{\eta}{n-\eta}
     * \right) \f$
     */
     ...
     *
     * @param T natural parameters \f$ \mathbf{\Theta} = \theta \f$
     * @return source parameters \f$ \mathbf{\Lambda} = \frac{\exp \theta}{1 +
     * \exp \theta} \f$
     */
     ...
     * @return \f$ D_{\mathrm{KL}}(f_1\|f_2) = n (1-p_1) \log \left(
     * \frac{1-p_1}{1-p_2} \right) + n p_1 \log \left( \frac{p_1}{p_2} \right)
     * \f$
     */
