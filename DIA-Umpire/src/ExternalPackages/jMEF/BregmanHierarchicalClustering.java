 ...
 * hierarchical mixture model (class HierarchicalMixtureModel). It is then
 * possible from this hierarchical mixture model to - quickly deduce a simpler
 * mixture model, - automatically learn the "optimal" number of components in
 * the mixture model.
 */
public class BregmanHierarchicalClustering {
    ...
    /**
     * Finds the two closest hierarchical mixture model relatively to a Bregman
     * divergence type.
     *
