 ...
 * Expectation parameters \f$ \mathbf{H} = (\eta_1,\cdots,\eta_{k-1}) \in
 * [0,n]^{k-1} \f$
 */
public final class MultinomialFixedN extends ExponentialFamily<PVector, PVector> {
     ...
     * @return natural parameters \f$ \mathbf{\Theta} = \left( \log \left(
     * \frac{p_i}{p_k} \right) \right)_i \f$
     */
     ...
     * @return \f$ D_{\mathrm{KL}}(f_1\|f_2) = n p_{\alpha,k} \log
     * \frac{p_{\alpha,k}}{p_{\beta,k}} - n \sum_{i=1}^{k-1} p_{\alpha,i} \log
     * \frac{p_{\beta,i}}{p_{\alpha,i}} \f$
     */
