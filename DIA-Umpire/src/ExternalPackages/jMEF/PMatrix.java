...
public class PMatrix extends Parameter {
    ...
    /**
     * Adds (not in place) the current matrix \f$ m_1 \f$ to the matrix \f$ m_2
     * \f$.
     *
    ...
    /**
     * Subtracts (not in place) the matrix \f$ m_2 \f$ to the current matrix \f$
     * v_1 \f$.
     *
    ...
    /**
     * Multiplies (not in place) the current matrix \f$ m \f$ by a real number
     * \f$ \lambda \f$.
     *
    ...
    /**
     * Computes the inner product (real number) between the current matrix \f$
     * m_1 \f$ and the matrix \f$ m_2 \f$.
     *
     * @param m2 vector \f$ m_2 \f$
    ...
    /**
     * Multiplies (not in place) the current matrix \f$ v_1 \f$ by the matrix
     * \f$ m_2 \f$.
     *
     * @param m2 matrix \f$ m_2 \f$
     * @return \f$ m_1 m_2\f$
    ...
    /**
     * Multiplies (not in place) the current matrix \f$ m \f$ by a vector \f$ v
     * \f$.
     *
    ...
    /**
     * Computes the inverse of the current matrix \f$ m \f$ using Gauss-Jordan
     * elimination.
     *
     * @return \f$ m^{-1} \f$
     */
    ...
    /**
     * Generates a random matrix \f$ m \f$ where each element is drawn from \f$
     * \mathcal{U}(0,1)\f$.
     *
     * @param dim dimension of the matrix
    ...
    /**
     * Generates a random matrix \f$ m \f$ such as \f$ m \f$ is a positive
     * definite matrix: Draw a lower triangular matrix \f$ L \f$ at random and
     * then return \f$ LL^T\f$.
     *
     * @param dim dimension of the matrix
