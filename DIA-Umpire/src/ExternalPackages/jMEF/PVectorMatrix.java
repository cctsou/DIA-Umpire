...
public final class PVectorMatrix extends Parameter {
    ...
    /**
     * Adds (not in place) the current vector-matrix \f$ (v_1, m_1) \f$ to the
     * vector-matrix \f$ (v_2, m_2) \f$.
     *
    ...
    /**
     * Subtracts (not in place) the vector-matrix \f$ (v_2, m_2) \f$ to the
     * current vector-matrix \f$ (v_1, m_1) \f$.
     *
     * @param v2m2 vector-matrix \f$ (v_2, m_2) \f$
     * @return \f$ ( v_1 - v_2, m_1 - m_2 ) \f$
     */
    ...
    /**
     * Multiplies (not in place) the current vector-matrix \f$ (v,m) \f$ by a
     * real number \f$ \lambda \f$.
     *
    ...
    /**
     * Computes the inner product (real number) between the current
     * vector-matrix \f$ ( v_1 , m_1 ) \f$ and the vector-matrix \f$ ( v_2 , m_2
     * ) \f$.
     *
     * @param v2m2 vector-matrix \f$ (v_2, m_2) \f$
    ...
    /**
     * Generates a random vector-matrix \f$ (v,m) \f$ such as \f$ m \f$ is a
    ...
    /**
     * Verifies if two vector-matrices \f$ (v_1 , m_1) \f$ and \f$ (v_2 , m_2)
     * \f$ are similar.
     *
