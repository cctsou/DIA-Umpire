...
/**
 * List to store {@code Alteration}s to the backingList of a
 * {@code PatchWorkArray}, so that elements can be accessed quickly.
 */
class AlterationList extends NaturalSortedList<Alteration> {
    ...
    /**
     * Deletes the alteration covering the given index in the
    ...
    /**
     * Obtains the {@code AlterationNode} that contains the {@code Alteration}
     * covering the given index or <code>null</code> in the case that no such
     * node exists.
     * <p>
     * Takes time <i>O(log(size())</i>.
     *
     * @param index the covered index to locate the {@code AlterationNode} for.
     * @return the {@code AlterationNode} covering the given index, or
    ...
    /**
     * Moves the {@code Removal} at the given index one position to the left and
     * increments its size by one, this should be used when removing an element
    ...
    /**
     * Gets the Removal which covers the given index, decreases its size by one
     * and shifts its index one place to the right.
     * <p>
     * This should be used in the case that you wish to add an element at the
     * position held by the start of the {@code Removal} covering the given
     * index and the {@code Removal} has size at least two.
     *
     * @param index the index of the {@code Removal}.
     */
    ...
    /**
     * Gets the {@code Removal} which covers the given index and increments its
     * size by one.
     * <p>
     * This should be used in the case that you wish to remove the element to
     * the right of this {@code Removal}.
     *
     * @param index the index of the {@code Removal}.
     */
    ...
    /**
     * Gets the Removal which covers the given index and decreases its size by
     * one.
     * <p>
     * This should be used in the case that you wish to add an element at the
     * position held by the end of the {@code Removal} covering this index and
     * the {@code Removal} has size at least two.
     *
     * @param index the index of the {@code Removal}.
     */
    ...
    /**
     * Gets the Alteration at the given index and adds the
     * <code>indexDiffChange</code> to its <code>indexDiff</code>.
     * <p>
     * Note that the <code>indexDiffChange</code> should be negative if you are
    ...
    /**
     * Gets the location of the element at the given index in the backingList
     * that this {@code AlterationList} is storing the changes to.
     * <p>
    ...
    /**
     * Returns the total "performance hit" of the {@code Alteration}s stored in
     * this {@code AlterationList}.
     * <p>
     * This method make use of a cached value and hence takes constant time.
     *
     * @return the total "performance hit" of the {@code Alteration}s stored in
     * this {@code AlterationList}.
     */
    ...
    class AlterationNode extends Node {
        ...
        /**
         * The difference in the index over the whole sub-tree rooted at this
         * node.
         * <p>
