...
public class PeakCurveClusteringCorrKDtree implements Runnable {
    ...
    public PeakCurveClusteringCorrKDtree(PeakCurve targeCurve, KDTree PeakCurveSearchTree, InstrumentParameter parameter, TreeMap<Float, XYData>[] IsotopePatternMap, int StartCharge, int EndCharge, int MaxNoClusters, int MinNoClusters, UpdateProcess update) {
...
//                                if (Peakcurve.TargetMz > 516.25 && Peakcurve.TargetMz < 516.29 && Peakcurve.StartRT() < 27.8 && Peakcurve.EndRT() > 27.4) {
//                                    System.out.println("");
//                                }
