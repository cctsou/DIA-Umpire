 ...
 */
public class GenerateLibFSByTraML {
    ...
    public static void main(String[] args) throws XmlPullParserException, Exception {
        ...
        String WorkFolder="F:\\Data\\Gomez_QE_DIA\\";
        //String TraML="phl004_canonical_s32_osw_decoys.TraML";
        String TraML="human-sample-spectral-library.traml";
        String Decoytag="DECOY";
        FragmentLibManager ExlibManager = new FragmentLibManager(FilenameUtils.getBaseName(TraML), null);
        ExlibManager.ImportFragLibByTraML(WorkFolder+TraML, Decoytag);
        ExlibManager.GenerateDecoyLib();
